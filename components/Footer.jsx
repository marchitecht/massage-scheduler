...
const Footer = () => {
  return (
    <footer className="p-10 bg-black">
      <div className="lg:grid grid-rows-3 grid-flow-col gap-1 sm:grid grid-rows-2">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-8 sm:grid-cols-4 mb-8">
          <div>
          ...
          <div>
            ...
            <ul className="text-gray-100 dark:text-gray-100">
              <li className="mb-4">
                <a
      ...
      <hr className=" border-gray-100 sm:mx-auto dark:border-gray-900 p-6" />
      <div className="sm:flex sm:items-center sm:justify-between bg-black">
